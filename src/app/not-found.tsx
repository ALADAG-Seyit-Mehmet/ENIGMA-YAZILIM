...
export default function GlobalNotFound() {
  return (
    <html lang="tr" className={`${inter.variable} ${spaceGrotesk.variable} ${jetbrainsMono.variable} h-full antialiased`}>
      <body className="min-h-full bg-[#050505]">
        <main className="relative z-10 flex flex-col items-center justify-center min-h-[80vh] px-6 text-center">
          <div className="inline-flex items-center gap-3 px-10 py-2.5 rounded-full border border-(--accent)/20 bg-(--accent)/5 mb-8 mt-[10vh]">
