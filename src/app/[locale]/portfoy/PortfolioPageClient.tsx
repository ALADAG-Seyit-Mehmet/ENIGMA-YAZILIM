    ...
    >
      ...
      <div className="flex items-end justify-between" style={{ height: "180px", padding: "0 32px 32px 32px" }}>
        ...
        <a
          ...
          className="flex items-center gap-2 px-5 py-3 rounded-full shrink-0 transition-all duration-300"
          style={{
    ...
    >
      ...
      <div className="flex flex-col gap-2" style={{ padding: "24px" }}>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="mt-2 inline-flex items-center gap-2 px-4 py-2.5 rounded-full self-start"
          style={{
            background: "rgba(255,255,255,0.04)",
